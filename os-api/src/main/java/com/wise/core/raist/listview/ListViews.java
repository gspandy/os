 ...
 * {@link com.wise.core.raist.listview.ListView} instances.
 *
...
public final class ListViews {
   ...
   * into a {@link com.wise.core.raist.listview.ListView} instance.
   *
   * @param array the array to copy and wrap, cannot be {@code null}.
   * @param <E> the referenced element type
   * @return the newly created {@link com.wise.core.raist.listview.ListView} instance
  ...
  /**
   * The method creates a {@link com.wise.core.raist.listview.ListView} instance that
   ...
   * wraps the copy into a {@link com.wise.core.raist.listview.ListView} instance.
   *
  ...
  /**
   * The method creates a {@link com.wise.core.raist.listview.ListView} instance

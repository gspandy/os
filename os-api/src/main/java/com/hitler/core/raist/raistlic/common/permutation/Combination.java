...
package com.hitler.core.raist.raistlic.common.permutation;
...
public class Combination<E> implements Iterable<List<E>> {
   ...
   * @return the created {@link com.hitler.core.raist.raistlic.common.permutation.Combination} instance.
   *

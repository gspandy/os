    ...
    "bootstrap_extended": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                '<a href="#" class="btn btn-sm default prev disabled" title="' + oLang.first + '"><i class="fa fa-angle-double-left"></i></a> ' +
                ...
                '<a href="#" class="btn btn-sm default next disabled" title="' + oLang.last + '"><i class="fa fa-angle-double-right"></i></a> ' +
                oLang.pageOf + ' <span class="pagination-panel-total"></span> ' + oLang.page + ' '+
                '</div>'
            );

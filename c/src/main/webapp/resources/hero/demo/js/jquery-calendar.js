...
var popUpCal = {
    ...
    showCalendar: function() {
        ...
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select" style="width:120px"><select id="calendar_hour">';
            ...
            timeSelect += '</select></div><div class="select" style=" width:10px;background:#fff;">' + this.timeSeparators[1] + '</div> <div class="select" style="width:110px"><select id="calendar_minute">';
            for (var a = 0; a <= 59; a++) {
        ...
        if (!this.changeMonth) {
            ...
            html += '<div class="select"><select id="calendar_newMonth">';
        ...
        if (!this.changeYear) {
            ...
            html += '<div class="select"><select id="calendar_newYear">';
    ...
    showTime: function() {
        ...
        var timeSelect = '';
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select" ><select id="calendar_hour" >';
            if (this.timeSeparators.length == 4) {
                if (this.selectedHour == 12 || this.selectedHour == 0) timeSelect += '<option value="12" selected="selected">12</option>';
                else timeSelect += '<option value="12">12</option>';
                for (var a = 1; a < 12; a++) {

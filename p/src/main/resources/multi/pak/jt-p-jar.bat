...
if exist "%MNIS_HOME%\bin\jt-p-jar.bat" goto okHome
set "MNIS_HOME=%~dp0.."
cd "%CURRENT_DIR%"

:gotHome
if exist "%MNIS_HOME%\bin\hitler-ha-db-run.bat" goto okHome
...
java -Xms32m -Xmx128m -XX:MaxNewSize=32m -XX:MaxPermSize=128m  -jar %MNIS_HOME%\jt-p-1.0.jar %1 &
